...
class Book{
    ...
    static addBookToLibrary(tempBook){
    ...
    static displayBooks(){
        ...
        myLibrary.forEach((libraryItem)=>{
            ...
            tempLibraryItemDiv = this.prepareLibraryItem(tempLibraryItemDiv, libraryItem);
    ...
    static clearLibraryBody(){
        libraryTableBodyDiv.innerHTML="";
    };
    
    static prepareLibraryItem(tempLibraryItemDiv, libraryItem){
